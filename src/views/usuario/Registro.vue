    ...
    <v-flex xs12 sm8 md6 lg5 xl4>
      <v-slide-y-transition mode="out-in" @enter="enter">
        <v-card v-if="vista == 1" :key="1" class="elevation-6">
          ...
          <v-card-text class="subheading text-xs-center">Regístrate con tu red social preferida</v-card-text>
          <v-card-text>
          ...
          >Regístrate con una cuenta de email y constraseña</v-card-text>
          <v-card-text>
            <v-text-field
          ...
          <v-card-text>
            <v-layout justify-end>
              <v-btn
                ...
                @click="siguiente(1, 'email')"
                color="secondary"
              >Siguiente</v-btn>
            </v-layout>
          </v-card-text>
          <v-card-actions>
            <v-btn :to="{ name: 'login' }" flat color="secondary">¿Ya tienes cuenta? Ingresa.</v-btn>
          </v-card-actions>
        </v-card>
